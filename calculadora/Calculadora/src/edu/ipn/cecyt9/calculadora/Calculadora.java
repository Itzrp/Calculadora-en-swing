...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(500, 500);
		setTitle("Ramos Pérez Itzel Alejandra");
		...
		pantalla.setFont(new Font("Century", Font.BOLD, 25));
		pantalla.setHorizontalAlignment(JTextField.RIGHT);
		pantalla.setEditable(false);
		pantalla.setBackground(new java.awt.Color(145, 219, 192));
		panel.add("North", pantalla);

		panelNumeros = new JPanel();
		panelNumeros.setLayout(new GridLayout(4, 3));
		panelNumeros.setBorder(new EmptyBorder(4, 4, 4, 4));
                panelNumeros.setBackground(new java.awt.Color(145, 219, 192));
		for (int n = 9; n >= 0; n--) {
		...
		panelOperaciones.setBorder(new EmptyBorder(4, 4, 4, 4));
                panelOperaciones.setBackground(new java.awt.Color(145, 219, 192));
		nuevoBotonOperacion("+");
		nuevoBotonOperacion("-");
		nuevoBotonOperacion("*");
		nuevoBotonOperacion("/");
                ...
                nuevoBotonOperacion("cbrt");
                nuevoBotonOperacion("atan");
                nuevoBotonOperacion("ceil");
		nuevoBotonOperacion("=");
	...
	private void nuevoBotonOperacion(String operacion) {
		...
		btn.setForeground(new java.awt.Color(219, 145, 209));
	...
	private void calcularResultado() {
		...
		} else if (operacion.equals("cbrt")) {
			resultado= Math.cbrt(new Double(pantalla.getText()));
		} else if (operacion.equals("atan")) {
			resultado= Math.atan(new Double(pantalla.getText()));
		} else if (operacion.equals("ceil")) {
			resultado= Math.ceil(new Double(pantalla.getText()));
		}
